...
* [Shell快速入门](./language/shell/beginning.md)
  ...
  * [Shell 文本处理](./language/shell/string.md)
  * [Shell 条件语句](./language/shell/condition.md)
...
* [Elasticsearch](./databases/elasicsearch/beginning.md)
...
* [Linux基础](./linux/basic/beginning.md)
  ...
  * [Linux文本搜索](./linux/basic/find.md)
  * [Linux文本处理之sed](./linux/basic/sed.md)
  * [Linux文本处理之awk](./linux/basic/awk.md)
...
* [Kubernetes](./cloud-native/kubernetes/beginning.md)
  ...
  * [Kubernetes 准入控制](./cloud-native/kubernetes/admission_controller.md)
